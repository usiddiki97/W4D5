...
# Before you start coding anything, talk it over with your partner. Sketch out on
# paper how you'd approach this problem. What would be the running time of your
...
# hammer. There are faster and more elegant ways to solve the problem, but we know
# for sure that this will get the job done.
...
# Write a second solution, called okay_two_sum?, which uses sorting. Make sure
# it works correctly.
...
# has O(1) #set and O(1) #get, so you can build a hash out of each of the n
# elements in your array in O(n) time. That hash map prevents you from having
# to repeatedly find values in the array; now you can just look them up instantly.
